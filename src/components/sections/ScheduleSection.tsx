              ...
              <div className="p-6 md:p-8 space-y-6">
                <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stone-800 pb-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold bg-stone-800 hover:bg-amber-500 hover:text-stone-950 text-stone-200 border border-stone-700 transition-all cursor-pointer"
                  >
                    {reminded ? (
                      <>
