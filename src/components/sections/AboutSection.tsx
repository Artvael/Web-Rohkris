    ...
    <section id="tentang" className="py-16 md:py-24 px-4 relative z-10">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="space-y-6">
          <h3 className="text-xl font-bold text-white text-center font-['Outfit']">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {values.map((v) => (
              <div
                key={v.title}
                className="p-5 rounded-2xl bg-stone-900/60 border border-stone-800 backdrop-blur-md space-y-2.5 hover:border-amber-500/40 transition-all"
              >
                <div className="p-2.5 rounded-xl bg-stone-950 w-fit border border-stone-800">
                  {v.icon}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="pt-2 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full p-0.5 bg-gradient-to-tr from-amber-400 to-sky-400 shrink-0">
          ...
          <div className="lg:col-span-6">
            <HalftoneReveal
              ...
              className="h-[340px] md:h-[400px] border border-amber-500/30 shadow-2xl shadow-amber-500/10"
        ...
        {/* Location & School Connection Banner */}
        <div className="p-6 md:p-8 rounded-3xl bg-gradient-to-r from-stone-900 via-stone-900 to-amber-950/40 border border-amber-500/20 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 px-5 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold text-xs shadow-lg shadow-amber-500/20 whitespace-nowrap transition-all cursor-pointer"
          >
