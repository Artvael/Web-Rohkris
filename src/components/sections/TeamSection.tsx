    ...
    <section id="pengurus" className="py-16 md:py-24 px-4 relative z-10">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="max-w-xl mx-auto w-full">
          <div className="relative h-44 md:h-52 rounded-3xl bg-stone-950/70 border border-amber-500/30 backdrop-blur-xl shadow-2xl overflow-hidden p-2">
            <div className="absolute left-4 top-3 text-[10px] uppercase font-bold text-amber-400/80 tracking-widest pointer-events-none z-20 flex items-center gap-1.5">
              <span>↕ Gulir / Geser untuk Memilih Divisi</span>
            </div>

            {/* Glowing active indicator background in center */}
            <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-14 bg-gradient-to-r from-amber-500/15 via-amber-500/25 to-transparent border-y border-amber-500/40 pointer-events-none z-0" />
        ...
        <motion.div
          ...
          className="p-5 rounded-2xl bg-stone-900/60 border border-amber-500/20 backdrop-blur-md max-w-3xl mx-auto text-center space-y-2"
        >
          <h3 className="text-lg font-bold text-amber-300 font-['Outfit']">
                ...
                <div className="p-6 flex flex-col justify-between h-full space-y-4">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div>
                        ...
                        <h4 className="text-base font-extrabold text-white font-['Outfit'] leading-tight">
                          {member.name}
                        </h4>
                        {member.grade && (
                    ...
                    {/* Member Quote */}
                    {member.quote && (
                      <div className="relative p-3 rounded-xl bg-stone-950/70 border border-stone-800 text-xs text-stone-300 italic leading-relaxed">
                        <Quote className="w-3.5 h-3.5 text-amber-400/50 mb-1" />
                  ...
                  {member.instagram && (
                    <div className="pt-2 border-t border-stone-800/80 flex items-center justify-between text-xs text-stone-400">
                      ...
                      <span className="text-[11px] text-stone-500">Rohkris 64</span>
                    </div>
                  )}
                </div>
              </BorderGlow>
