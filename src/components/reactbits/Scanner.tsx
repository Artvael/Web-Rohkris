...
const directionToFloat = (dir: 'vertical' | 'horizontal' | 'diagonal'): number =>
...
const ctxMap = new WeakMap<HTMLElement, CtxData>();
...
export const Scanner: React.FC<ScannerProps> = ({
  ...
  return <div ref={containerRef} style={style} className={`scanner-container ${className}`.trim()} />;
};
